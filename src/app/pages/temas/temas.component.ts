  ...
  template: `
    ...
    <section class="github-section">
      ...
      <ol>
        ...
        <li><strong>Crear un nuevo repositorio:</strong> 
          Ingresa a tu cuenta, haz clic en <em>New Repository</em> y completa los datos.
        </li>
        ...
        <li><strong>Crear un nuevo archivo o proyecto Java:</strong>
          Guarda tu código en la carpeta del repositorio.
        </li>
